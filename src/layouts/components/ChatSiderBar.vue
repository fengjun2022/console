<template>
  ...
  >
    <div :class="[isSidebarMinimized && 'items-center']" class="flex flex-col h-full">
      ...
      <!-- 固定功能列表区域 -->
      <div class="px-1 pt-2 overflow-hidden overflow-y-auto " :style="{ height: fixedItemsHeight + 'px', borderColor:  themeColors.sidebarBorder ,
...
import { getThemeColors } from '@/config/theme.js'
