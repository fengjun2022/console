<template>
  <NConfigProvider :theme="isDarkMode ? darkTheme : null">
    <NMessageProvider>
      <div class="app-layout h-screen flex flex-col transition-colors duration-300" :style="{ backgroundColor: themeColors.main }">
        <!-- 头部导航 -->
          ...
          >
            <div class="space-y-6">
              <div class="flex items-center justify-between">
                ...
                <NSwitch
                  v-model:value="isHeaderVisible"
                  @update:value="globalStore.setHeaderVisible"
                />
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <NSwitch
                  v-model:value="isBreadcrumbBarVisible"
                  @update:value="globalStore.setBreadcrumbBarVisible"
                />
              </div>
            </div>
          </NDrawerContent>
